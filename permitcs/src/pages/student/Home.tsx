...
export default function StudentHome() {
  ...
  const recent = studentRequests.slice(0, 3);

  const quickActions = [
    { label: 'New Request', icon: Plus, color: '#F97316', bg: 'rgba(249,115,22,0.09)', to: '/student/new-request' },
    { label: 'My Requests', icon: ClipboardList, color: '#10B981', bg: 'rgba(16,185,129,0.09)', to: '/student/new-request' },
  ...
  return (
    <PageWrapper role="student">
      ...
      >
        {/* Emblem/Avatar */}
        <div style={{
          width: user?.avatarUrl ? 64 : 60,
          height: user?.avatarUrl ? 80 : 60,
          borderRadius: user?.avatarUrl ? 8 : '50%',
          background: '#ffffff',
          border: user?.avatarUrl ? '1.5px solid #E2E8F0' : '2px solid #EEF2F7',
          boxShadow: user?.avatarUrl ? '0 2px 6px rgba(0,0,0,0.04)' : '0 4px 10px rgba(0,0,0,0.05)',
        ...
        <div style={{ flex: 1 }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: 8, marginBottom: 6 }}>
            ...
            <span style={{ fontSize: 11, fontWeight: 700, background: '#D1FAE5', color: '#065F46', padding: '2px 8px', borderRadius: 20 }}>Active</span>
          </div>
