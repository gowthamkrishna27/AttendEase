    ...
    <div className="landing-page-wrapper">
      ...
      <nav className="landing-nav">
        <div className="landing-container landing-nav-inner">
          <Link to="/" className="landing-nav-logo landing-display-font">
            <img
              src="https://res.cloudinary.com/q40pqnho/image/upload/v1786110180/WhatsApp_Image_2026-08-07_at_4.50.24_PM_upzknj.jpg"
              alt="Attend Ease Logo"
              className="landing-nav-logo-img"
            />
            <span>Attend Ease</span>
          </Link>
      ...
      <section className="landing-marquee-wrapper">
        ...
        <div className="landing-marquee-container">
          {[
            ...
            { title: "Student Portal", src: "https://res.cloudinary.com/q40pqnho/image/upload/v1786111827/WhatsApp_Image_2026-08-07_at_7.31.49_PM_a3fg9y.jpg" },
            { title: "Faculty Attendance", src: "https://res.cloudinary.com/q40pqnho/image/upload/v1786111804/WhatsApp_Image_2026-08-07_at_7.31.49_PM_1_kpuvlu.jpg" },
            { title: "HOD Dashboard", src: "https://res.cloudinary.com/q40pqnho/image/upload/v1786111866/WhatsApp_Image_2026-08-07_at_7.31.50_PM_lxvppb.jpg" },
